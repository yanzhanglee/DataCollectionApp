...
public class BatteryCharges {

    private List<BatteryChargesItem> list;

    public List<BatteryChargesItem> getList() {
        return list;
    }

    public void setList(List<BatteryChargesItem> list) {
        this.list = list;
    }

    public static class BatteryChargesItem implements Serializable {
